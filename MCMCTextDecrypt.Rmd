...
Decryption of a basic substitution cipher using Markov Chain Monte Carlo.
The novel War and Peace is usedto create the transition matrix, which 
the probability of one letter being followed by another stored as a matrix.
